...
KaisPagi (Malay: morning porridge — the simplest, cheapest meal) is an AI-powered poverty simulation game that puts you in the shoes of a B40 household in Malaysia.
Over 15 days, you face the real financial decisions that low-income Malaysians navigate every day — unexpected medical bills, school fees, job instability, rising food prices, and the constant threat of debt. Every choice has consequences. There are no perfect options.
